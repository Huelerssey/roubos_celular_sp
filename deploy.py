...
if opcao_selecionada == 'Maps':
    ...
    mapeamento_graficos = {
        'Mancha Criminal Cluster - Estado de São Paulo 2022': 'mapa_cluster_estado.html',
        'Mancha Criminal Heat - Estado de São Paulo 2022': 'mapa_heatmap_estado.html',
        'Mancha Criminal Cluster - Capital de São Paulo 2022': 'mapa_cluster_capital.html',
        'Mancha Criminal Heat - Capital de São Paulo 2022': 'mapa_heatmap_capital.html'
